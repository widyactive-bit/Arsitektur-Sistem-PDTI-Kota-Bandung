...
<body>
    ...
    <div class="section-title">Profil Pelatih</div>
    <table class="profile-table">
        ...
        <tr>
            <td class="label">Lisensi / Sertifikat</td>
            <td>: {{ $coach->lisensi }} (Berlaku hingga: {{ $coach->masa_berlaku_lisensi->format('d-m-Y') }})</td>
        </tr>
        <tr>
            <td class="label">Klub Binaan</td>
            <td>: {{ $coach->klub }}</td>
        </tr>
        <tr>
            <td class="label">No. Telepon / HP</td>
            <td>: {{ $coach->nomor_hp }}</td>
        </tr>
        <tr>
    ...
    <div class="section-title">Daftar Atlet Binaan Aktif</div>
    <table class="data-table">
        <thead>
            <tr>
                <th style="width: 5%;">No</th>
                <th style="width: 25%;">Nomor Induk (NIA)</th>
                <th style="width: 40%;">Nama Atlet</th>
                <th style="width: 20%;">Posisi / Kelas</th>
                <th style="width: 10%;">Status</th>
            </tr>
        </thead>
        <tbody>
            @forelse($coach->athletes as $index => $ath)
            <tr>
                <td>{{ $index + 1 }}</td>
            ...
            @empty
            <tr>
                <td colspan="5" style="text-align: center; color: #888; font-style: italic;">Belum ada daftar atlet sepak takraw yang dibina.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
